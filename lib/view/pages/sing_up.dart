            ...
            child: Form(
              ...
              child: Column(
                children: [
                  OrangeLogoFontStyle(),
                  BoldText('Sign Up'),
                  Textfield(hint: 'Name', txtcontroler: nameController),
                  Textfield(validator: (value) {
                    if (value!.isEmpty) {
                      return 'email must not be empty';
                    }
                    if (!EmailValidator.validate(value)) {
                    ...
                    return null;
                  },type: TextInputType.emailAddress, hint: 'E-Mail', txtcontroler: emailController),
                  Textfield(
                      hint: 'Phone',
                      type: TextInputType.number,
                      txtcontroler: phoneController),
                  Textfield(
                      isPassword: isPassword,
                      onPressedIcon: () {
                        isPassword = !isPassword;
                      ...
                      icon: isPassword
                          ? Icons.visibility
                          : Icons.visibility_off,
                      txtcontroler: passwordController),
                  Textfield(
                      isPassword: isPassword2,
                      onPressedIcon: () {
                        isPassword2 = !isPassword2;
                      ...
                      icon: isPassword2
                          ? Icons.visibility
                          : Icons.visibility_off,
                      txtcontroler: conPasswordController),
                  DropDown(
                      name: 'Gender',
                      icon: Icons.man_rounded,
                       item:genderItem,
                  ...
                  OrDvider(),
                  LoginButton(
                      Colors.white, 'Sign up', Colors.deepOrange, context, () {}),
                ],
              ),
            ),
          ),
